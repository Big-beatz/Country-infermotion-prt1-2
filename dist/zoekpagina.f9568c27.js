...
})({"hGOVq":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "50a6e291f9568c27";
...
},{}],"1TEPs":[function(require,module,exports) {
...
async function fetchOneCountry(name) {
    ...
    try {
        ...
        if (oneCountry.data[0].currencies.length === 1) searchResult.innerHTML = `<span id="bigName"><img src="${flag}" alt="Flag" id="countryFlag">
                                  ${countryName}</span>
        ...
        else if (oneCountry.data[0].currencies.length > 1) searchResult.innerHTML = `<span id="bigName"><img src="${flag}" alt="Flag" id="countryFlag">${countryName}</span>
                                  <p>${countryName} is situated in ${subregion}. It has a population of ${population} people.</p>
...
},{}]},["hGOVq","1TEPs"], "1TEPs", "parcelRequirecb08")

//# sourceMappingURL=zoekpagina.f9568c27.js.map
