...
async function fetchCountries() {
    try {
        ...
        } else if (e.response.status === 500) errorMessage.textContent = "Er ging iets fout in de server";
        else errorMessage.textContent = "We weten niet wat er fout ging, probeer het later nog eens";
    }
}
//Roep de functie aan
fetchCountries();
